...
//		System.out.println("[DBG] Label: " + selfLabel + " <=> " + label);
//		System.out.println("[DBG] Value: " + selfValue + " <=> " + value);
//		System.out.println("[DBG] PkgName: " + selfPkgName + " <=> " + pkgName);
//		System.out.println("[DBG] ClassName: " + selfClassName + " <=> " + className);
	...
	public void print() {
		...
		UTASTNodeExpressHandler.representData2(subLblTreeNodeList, list);
